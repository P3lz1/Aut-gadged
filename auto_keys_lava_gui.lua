...
for i = 1, 11 do
    ...
    stripe.Size = UDim2.new(0, math.random(80, 165), 0, math.random(7, 18))
    stripe.Position = UDim2.new(0, math.random(-150, 292), 0, math.random(0, 318))
    stripe.BackgroundColor3 = Color3.fromRGB(255, math.random(45, 120), 0)
    stripe.BackgroundTransparency = math.random(18, 45) / 100
    stripe.BorderSizePixel = 0
    stripe.Rotation = math.random(-10, 10)
    stripe.ZIndex = 1
    stripe.Parent = frame
    ...
    task.spawn(function()
        while stripe.Parent do
            local tween = TweenService:Create(
                stripe,
                TweenInfo.new(math.random(10, 24) / 10, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut),
                {
                    Position = UDim2.new(0, math.random(-150, 292), 0, math.random(0, 318)),
                    BackgroundTransparency = math.random(15, 52) / 100,
