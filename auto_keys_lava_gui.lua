...
local lavaClips = {
    { rect = Vector2.new(0, 70), size = Vector2.new(300, 34), y = 58, h = 38, speed = 3.2 },
    { rect = Vector2.new(30, 88), size = Vector2.new(230, 26), y = 108, h = 30, speed = 2.6 },
    { rect = Vector2.new(0, 112), size = Vector2.new(300, 25), y = 165, h = 29, speed = 2.9 },
    { rect = Vector2.new(45, 36), size = Vector2.new(210, 22), y = 226, h = 26, speed = 2.3 },
}

for _, clip in ipairs(lavaClips) do
    local strip = Instance.new("ImageLabel")
    strip.Size = UDim2.new(0, 292, 0, clip.h)
    ...
    task.spawn(function()
        while strip.Parent do
            ...
            local tween = TweenService:Create(
                ...
                { Position = UDim2.new(0, -292, 0, clip.y) }
            )
